...
def get_boycott_data_AR():
    ...
    boycott_data = {
        "الأغذية والمشروبات": {
            "companies": [
                {
                    "name": "ستاربكس", # name بدون الرقم '1'
...
# مثال لكيفية ظهور بيانات ستاربكس الآن:
# {
#     "name": "ستاربكس",
...
# يمكنك الآن استدعاء الدالة للحصول على البيانات بالمفاتيح النهائية المطلوبة
# arabic_data_final = get_boycott_data_arabic_final_keys()
# print(arabic_data_final)
                ...
                with tab:
                    ...
                    for resource in resources[category]:
                        with st.expander(f"{resource['title']}", expanded=False):
                            ...
                            for source in resource['sources1']:
